...
12.2 รายละเอียดไฟล์ Source Code
...
12.4 ชื่อ Repository

ชื่อ Repository ที่กำหนดสำหรับกลุ่ม 08 คือ

stack-algorithm-group08

สมาชิกทุกคนในกลุ่มควรมี Commit ใน Repository และต้องสามารถอธิบาย Source Code และส่วนที่ตนเองรับผิดชอบได้

12.5 ตัวอย่าง Commit Message
...
12.7 ขนาดข้อมูลที่ใช้ในการทดลอง
...
10                   500                            16                          6,140                        28                  PASS

100                 9,200                           416                         62,760                       386                 PASS

1,000              124,660                         7,033                       341,080                      3,978                PASS
 
5,000              329,180                         49,890                      821,480                      19,958               PASS

10,000             181,440                        134,980                     1,828,500                     39,954               PASS
